...
function StudentAuthShell({ children }: { children: ReactNode }) {
  return <div className="student-shell"><header className="topbar" style={{ padding: '.85rem 1rem' }}><Link href="/" style={{ color: 'inherit', textDecoration: 'none' }}><LogoMark compact /></Link></header><main className="student-content">{children}</main></div>;
}
